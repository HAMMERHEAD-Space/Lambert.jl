...
function SciMLBase.solve(problem::LambertProblem, solver::AvanziniSolver)
    ...
    v1, v2 = avanzini2008(μ, r1, r2, tof; M=M, prograde=prograde, maxiter=maxiter, atol=atol, dx=dx, x_init=x_init)
...
"""
function avanzini2008(μ::Number, r1::Vector{<:Number}, r2::Vector{<:Number}, tof::Number; M::Int=0, prograde::Bool=true, maxiter::Int=35, atol::Float64=1e-5, dx::Float64=1e-3, x_init::Float64=0.0)
